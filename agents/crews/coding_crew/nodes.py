...
class CodingCrewNodes:
    ...
    def executor_node(self, state: CodingCrewState) -> Dict[str, Any]:
        ...
        # 预热沙箱
        try:
            current_sandbox.warm_up()
        except Exception as e:
             return {"execution_stderr": f"Sandbox Warmup Failed: {e}", "execution_passed": False}
        
        # 运行
        stdout, stderr, images = current_sandbox.run_code(code)
...
# --- Global Instance for Graph Imports ---
# 修复 graph.py 中 `from ... import _sandbox` 的引用错误
try:
    _sandbox = DockerSandbox()
except Exception as e:
    print(f"⚠️ Global Sandbox init failed in nodes.py: {e}")
    _sandbox = None
